<<<<<<< HEAD:matconvnet-1.0-beta7/examples/makeCnnData.m
function [imdb] = makeCnnData(images, folders, opts)
=======
<<<<<<< HEAD
function [imdb] = makeCnnData(folders, image)

=======
function makeCnnData(images, folders, opts)
>>>>>>> e18bc7794dd734286bffe846fdb2b7b427f10dfb:matconvnet-1.0-beta7/examples/makeCnnData_luo.m
...
for i = 1 : length(image)    
    imdb.images.name{i} = [image(i).work_path filesep image(i).names];
    imdb.images.score(i) = image(i).score;
    imdb.folder.id(i) = image(i).id;
    imdb.images.id(i) = folders(i).folder_id;
end
=======
imdb.images.id = [];
>>>>>>> 1af32556296f6019871e81b3cac5df1838598635
