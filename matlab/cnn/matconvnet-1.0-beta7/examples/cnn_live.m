function cnn_live(varargin)
% CNN_LIVE   Demonstrates MatConvNet on CIFAR

run(fullfile(fileparts(mfilename('fullpath')), '../matlab/vl_setupnn.m')) ;

opts.dataDir = 'data/' ;
opts.expDir = 'data/live-baseline' ;
opts.imdbPath = fullfile(opts.expDir, 'imdb-typebyfolder.mat');
...
if opts.test_small
    %-only put test bad picture in cnn------------------------------
    imdb.images.set(find(images.scores<=5)) = 0;
