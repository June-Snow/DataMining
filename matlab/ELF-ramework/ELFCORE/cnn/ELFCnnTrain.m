...
if trainType == 1
    configPath = [root filesep 'elf_config_train_classification.ini'];%CNN模型路径
end
if trainType == 2
    configPath = [root filesep 'elf_config_train_regression.ini'];%CNN模型路径
end
...
for i = 1 : batchSize : nFeature
    ...
    pred = [pred; iRet2Pred(layerRet(end-1).x, trainType) ];
